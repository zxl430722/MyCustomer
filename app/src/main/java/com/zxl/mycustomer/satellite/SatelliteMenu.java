package com.zxl.mycustomer.satellite;
...
import com.zxl.mycustomer.R;

/**
 * author: ZXL
 * created on: 2017/8/11 14:50
 * description:卫星菜单
 */
...
public class SatelliteMenu extends ViewGroup implements View.OnClickListener {
    ...
    private final int LEFT_TOP = 1001;
    private final int RIGHT_TOP = 1002;
    private final int LEFT_BOTTOM = 1003;
    private final int RIGHT_BOTTOM = 1004;
